  ...
  return (
    <div className="about-page">
      ...
      <section className="about-mission">
        <h2>Our Mission</h2>
        <p>
          To deliver premium car enhancement solutions that combine comfort,
          style, and performance — ensuring every ride is a proud experience.
        </p>

        <h2>Our Vision</h2>
        <p>
          To become the go-to car decor destination known for trust, innovation,
          and customer satisfaction in the automobile accessory industry.
        </p>
      </section>
